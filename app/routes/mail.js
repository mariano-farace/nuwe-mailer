 ...
 * @tags mail
 * @param {emailData} request.body.required - The recipient, emitter and mail data
 ...
 * Email data
 * @typedef {object} emailData
 * @property {name} name.required - The name of the user to whom welcome email will be sent
 * @property {email} email.required - User email
 */

/**
 * POST //register
 * @summary Send welcome email to specified email address
 * @tags mail
 * @param {emailData} request.body.required - The user data
 * @return {object} 200 - success response - application/json
 * @return {object} 400 - Bad request response
 * @return {object} 500 - Internal server error response
 * @example request - Payload example
